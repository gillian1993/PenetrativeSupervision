...
export function SkillAssetManagementPage(){
  ...
  return <>
    <PageHeader eyebrow="场景与规则 / Skill管理" title="Skill管理" description="填写基本信息和审查需求，由系统生成可编辑的审查内容、审查要求和输出结果。" actions={<><Button icon="refresh" onClick={()=>void load()}>刷新</Button><Button variant="primary" icon="plus" onClick={()=>navigate('/skills/new')}>新增Skill</Button></>}/>
