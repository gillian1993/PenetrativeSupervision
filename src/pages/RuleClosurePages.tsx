...
export function RuleManagementPage(){
  ...
  return <>
    <PageHeader eyebrow="场景与规则 / 规则管理" title="规则管理" description="集中查看规则，并完成新增、编辑和删除草稿规则的最小闭环。" actions={<><Button icon="refresh" onClick={()=>void load()}>刷新</Button><Button variant="primary" icon="plus" onClick={openNew}>新增规则</Button></>}/>
