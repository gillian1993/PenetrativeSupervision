...
export const sceneRuleApi={
  ...
  createRule:(payload:{name:string;code?:string;version?:string;type?:string;level?:string;domain?:string;libraryName?:string;directoryName?:string;description?:string;status?:string;objectCode?:string;objectName?:string;eventCode?:string;eventName?:string;ontologyId?:string;graphVersion?:string})=>request<RuleItem>('/api/rules',{method:'POST',body:JSON.stringify(payload)}),
